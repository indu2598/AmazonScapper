...
class AmazonSpider(scrapy.Spider):
    name = 'amazon'  #spider name
    # allowed_domains = ['amazon.com']
    page_number = 2
    start_urls = ['https://www.amazon.in/gp/bestsellers/books/ref=nav_ya_signin?ie=UTF8&pg=1&'] #site which is going to be scrsp

    def parse(self, response):

        myitems = AmazonscrapperItem()
        ...
        next_page = 'https://www.amazon.in/gp/bestsellers/books/ref=nav_ya_signin?ie=UTF8&pg='+str(AmazonSpider.page_number)+'&'
